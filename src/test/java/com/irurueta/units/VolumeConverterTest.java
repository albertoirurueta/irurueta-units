...
public class VolumeConverterTest {
    ...
    public void testCubicMeterCubicCentimeter() {
        ...
        assertEquals(inputValue / CUBIC_METER_PER_CUBIC_CENTIMETER,
                VolumeConverter.cubicMeterToCubicCentimeter(inputValue),
                ERROR);
        assertEquals(inputValue * CUBIC_METER_PER_CUBIC_CENTIMETER,
                VolumeConverter.cubicCentimeterToCubicMeter(inputValue),
                ERROR);
    }
    ...
    public void testCubicMeterMilliliter() {
        ...
        assertEquals(inputValue / CUBIC_METER_PER_MILLILITER,
                VolumeConverter.cubicMeterToMilliliter(inputValue),
                ERROR);
        assertEquals(inputValue * CUBIC_METER_PER_MILLILITER,
                VolumeConverter.milliliterToCubicMeter(inputValue),
                ERROR);
    }
    ...
    public void testCubicMeterCubicDecimeter() {
        ...
        assertEquals(inputValue / CUBIC_METER_PER_CUBIC_DECIMETER,
                VolumeConverter.cubicMeterToCubicDecimeter(inputValue),
                ERROR);
        assertEquals(inputValue * CUBIC_METER_PER_CUBIC_DECIMETER,
                VolumeConverter.cubicDecimeterToCubicMeter(inputValue),
                ERROR);
    }
    ...
    public void testCubicMeterLiter() {
        ...
        assertEquals(inputValue / CUBIC_METER_PER_LITER,
                VolumeConverter.cubicMeterToLiter(inputValue),
                ERROR);
        assertEquals(inputValue * CUBIC_METER_PER_LITER,
                VolumeConverter.literToCubicMeter(inputValue),
                ERROR);
    }
    ...
    public void testCubicMeterHectoliter() {
        ...
        assertEquals(inputValue / CUBIC_METER_PER_HECTOLITER,
                VolumeConverter.cubicMeterToHectoliter(inputValue),
                ERROR);
        assertEquals(inputValue * CUBIC_METER_PER_HECTOLITER,
                VolumeConverter.hectoliterToCubicMeter(inputValue),
                ERROR);
    }
    ...
    public void testCubicMeterCubicInch() {
        ...
        assertEquals(inputValue / CUBIC_METER_PER_CUBIC_INCH,
                VolumeConverter.cubicMeterToCubicInch(inputValue),
                ERROR);
        assertEquals(inputValue * CUBIC_METER_PER_CUBIC_INCH,
                VolumeConverter.cubicInchToCubicMeter(inputValue),
                ERROR);
    }
    ...
    public void testCubicMeterPint() {
        ...
        assertEquals(inputValue / CUBIC_METER_PER_PINT,
                VolumeConverter.cubicMeterToPint(inputValue),
                ERROR);
        assertEquals(inputValue * CUBIC_METER_PER_PINT,
                VolumeConverter.pintToCubicMeter(inputValue),
                ERROR);
    }
