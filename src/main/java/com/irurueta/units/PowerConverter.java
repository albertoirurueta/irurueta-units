...
public class PowerConverter {
    ...
    /**
     * Number of watts in 1 horsepower (mechanical horsepower).
     */
    static final double WATTS_PER_HORSEPOWER = 745.6998715822702;
    ...
    /**
     * Converts provided kilowatt value to watts.
     *
     * @param kilowatt kilowatt value.
     * @return same power converted to watts.
     */
    ...
    /**
     * Converts provided watt value to kilowatts.
     *
     * @param watt watt value.
     * @return same power converted to kilowatts.
     */
    ...
    /**
     * Converts provided megawatt value to watts.
     *
    ...
    /**
     * Converts provided watt value to megawatts.
     *
     * @param watt watt value.
     * @return same power converted to megawatts.
     */
    ...
    /**
     * Converts provided horsepower value to watts.
     *
