...
public class AngleConverter {
     ...
     */
    public static Angle convertAndReturnNew(
            final Angle input, final AngleUnit outputUnit) {
    ...
    public static void convert(
            final Angle angle, final AngleUnit outputUnit) {
    ...
    public static Number convert(
            final Number input, final AngleUnit inputUnit,
    ...
    public static void toDegreesAndMinutes(
        ...
        final double decimalDegrees = convert(value, unit,
                AngleUnit.DEGREES);

        final double degrees = Math.floor(decimalDegrees);

        final double remainderDegrees = decimalDegrees - degrees;
        final double decimalMinutes = remainderDegrees * DEGREES_TO_MINUTES;
     ...
     */
    public static double[] toDegreesAndMinutes(
            final double value, final AngleUnit unit) {
        final double[] result = new double[DEGREES_AND_MINUTES];
     ...
     */
    public static void toDegreesAndMinutes(
            final Angle angle, final double[] result) {
    ...
    public static double fromDegreesAndMinutes(
            final int degrees, final double minutes,
     ...
     * @throws IllegalArgumentException if minutes is negative.
     */
    public static void fromDegreesAndMinutes(
            final int degrees, final double minutes, final Angle result) {
        result.setValue(fromDegreesAndMinutes(degrees, minutes,
                result.getUnit()));
    }
    ...
    public static Angle fromDegreesAndMinutesAndReturnNew(
            final int degrees, final double minutes,
            final AngleUnit resultUnit) {
        final Angle result = new Angle(0.0, resultUnit);
    ...
    public static void toDegreesMinutesAndSeconds(
        ...
        final double minutes = Math.floor(decimalMinutes);

        final double remainderMinutes = decimalMinutes - minutes;
        final double decimalSeconds = remainderMinutes * MINUTES_TO_SECONDS;
     ...
     */
    public static double[] toDegreesMinutesAndSeconds(
            final double value, final AngleUnit unit) {
        final double[] result = new double[DEGREES_MINUTES_AND_SECONDS];
    ...
    public static void toDegreesMinutesAndSeconds(
            final Angle angle, final double[] result) {
        toDegreesMinutesAndSeconds(angle.getValue(), angle.getUnit(),
                result);
    }
    ...
    public static double[] toDegreesMinutesAndSeconds(
            final Angle angle) {
        return toDegreesMinutesAndSeconds(angle.getValue(),
                angle.getUnit());
    }
    ...
    public static double fromDegreesMinutesAndSeconds(
            final int degrees, final int minutes,
            final double seconds, final AngleUnit resultUnit) {
    ...
    public static void fromDegreesMinutesAndSeconds(
            final int degrees, final int minutes,
            final double seconds, final Angle result) {
    ...
    public static Angle fromDegreesMinutesAndSecondsAndReturnNew(
            final int degrees, final int minutes, final double seconds,
            final AngleUnit resultUnit) {
        final Angle result = new Angle(0.0, resultUnit);
