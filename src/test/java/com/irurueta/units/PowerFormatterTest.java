...
class PowerFormatterTest {
    ...
    void testClone() throws CloneNotSupportedException {
        ...
        assertNotNull(formatter1.format(0.5, PowerUnit.WATT, new StringBuffer(),
                new FieldPosition(0)));
    ...
    void testFormatDoubleAndStringBuffer() {
        ...
        var buffer = new StringBuffer();
        assertEquals("5,5 W", formatter.format(value, PowerUnit.WATT, buffer,
                new FieldPosition(0)).toString());
        ...
        buffer = new StringBuffer();
        assertEquals("5,5 MW", formatter.format(value, PowerUnit.MEGAWATT, buffer,
                new FieldPosition(0)).toString());
    ...
    void testFormatAndConvertNumber() {
        ...
        assertEquals("0,1 W", formatter.formatAndConvert(new BigDecimal("0.1"),
                PowerUnit.WATT));
        assertEquals("1,5 kW", formatter.formatAndConvert(new BigDecimal("1500"),
                PowerUnit.WATT));
        assertEquals("2,5 MW", formatter.formatAndConvert(new BigDecimal("2500000"),
                PowerUnit.WATT));

        assertEquals("1,49 kW", formatter.formatAndConvert(new BigDecimal("2.0"),
        ...
        assertEquals("1.34 hp", formatter.formatAndConvert(new BigDecimal("1000"),
                PowerUnit.WATT));
        assertEquals("1 hp", formatter.formatAndConvert(new BigDecimal("745.6998715822702"),
                PowerUnit.WATT));
    }
    ...
    void testFormatAndConvertDouble() {
        ...
        assertEquals("0,1 W", formatter.formatAndConvert(0.1, PowerUnit.WATT));
        assertEquals("1,5 kW", formatter.formatAndConvert(1500.0, PowerUnit.WATT));
        assertEquals("2,5 MW", formatter.formatAndConvert(2500000.0, PowerUnit.WATT));

        assertEquals("1,49 kW", formatter.formatAndConvert(2.0, PowerUnit.HORSEPOWER));
        ...
        assertEquals("1.34 hp", formatter.formatAndConvert(1000.0, PowerUnit.WATT));
        assertEquals("1 hp", formatter.formatAndConvert(745.6998715822702, PowerUnit.WATT));
    }
    ...
    void testFormatAndConvertPower() {
        ...
        assertEquals("0,1 W", formatter.formatAndConvert(new Power(0.1, PowerUnit.WATT)));
        assertEquals("1,5 kW", formatter.formatAndConvert(new Power(1500.0,
                PowerUnit.WATT)));
        assertEquals("2,5 MW", formatter.formatAndConvert(new Power(2500000.0,
                PowerUnit.WATT)));

        assertEquals("1,49 kW", formatter.formatAndConvert(new Power(2.0,
                PowerUnit.HORSEPOWER)));
        ...
        assertEquals("1.34 hp", formatter.formatAndConvert(new Power(1000.0, PowerUnit.WATT)));
        assertEquals("1 hp", formatter.formatAndConvert(new Power(745.6998715822702, PowerUnit.WATT)));
    }
    ...
    void testFormatAndConvertNumberAndUnitSystem() {
        ...
        assertEquals("0,1 W", formatter.formatAndConvert(new BigDecimal("0.1"),
                PowerUnit.WATT, UnitSystem.METRIC));
        assertEquals("1,5 kW", formatter.formatAndConvert(new BigDecimal("1500"),
                PowerUnit.WATT, UnitSystem.METRIC));
        assertEquals("2,5 MW", formatter.formatAndConvert(new BigDecimal("2500000"),
                PowerUnit.WATT, UnitSystem.METRIC));
        ...
        assertEquals("1,49 kW", formatter.formatAndConvert(new BigDecimal("2.0"),
                PowerUnit.HORSEPOWER, UnitSystem.METRIC));

        assertEquals("1,34 hp", formatter.formatAndConvert(new BigDecimal("1000"),
                PowerUnit.WATT, UnitSystem.IMPERIAL));
        assertEquals("1 hp", formatter.formatAndConvert(new BigDecimal("745.6998715822702"),
                PowerUnit.WATT, UnitSystem.IMPERIAL));
    }
    ...
    void testFormatAndConvertPowerAndUnitSystem() {
        ...
        assertEquals("1,49 kW", formatter.formatAndConvert(new Power(2.0, PowerUnit.HORSEPOWER),
                UnitSystem.METRIC));
    ...
    void testFormatAndConvertMetric() {
        ...
        assertEquals("0,1 W", formatter.formatAndConvertMetric(new BigDecimal("0.1"),
                PowerUnit.WATT));
        assertEquals("1,5 kW", formatter.formatAndConvertMetric(new BigDecimal("1500"),
                PowerUnit.WATT));
        assertEquals("2,5 MW", formatter.formatAndConvertMetric(new BigDecimal("2500000"),
                PowerUnit.WATT));

        assertEquals("1,49 kW", formatter.formatAndConvertMetric(new BigDecimal("2.0"),
                PowerUnit.HORSEPOWER));
    }
    ...
    void testFormatAndConvertImperial() {
        ...
        assertEquals("1.34 hp", formatter.formatAndConvertImperial(new BigDecimal("1000"),
                PowerUnit.WATT));
        assertEquals("1 hp", formatter.formatAndConvertImperial(new BigDecimal("745.6998715822702"),
                PowerUnit.WATT));
    }
    ...
    void testIsValidMeasurement() {
        final PowerFormatter formatter = new PowerFormatter(new Locale("es", "ES"));
