...
public class EnergyConverter {
    ...
    /**
     * Number of joules in 1 BTU (International Table BTU).
     */
    ...
    public static double convert(final double input, final EnergyUnit inputUnit, final EnergyUnit outputUnit) {
        //convert to joules
        final var joule = switch (inputUnit) {
        ...
        return switch (outputUnit) {
            case KILOJOULE -> jouleToKilojoule(joule);
            case CALORIE -> jouleToCalorie(joule);
            case KILOCALORIE -> jouleToKilocalorie(joule);
            case KILOWATT_HOUR -> jouleToKilowattHour(joule);
            case BTU -> jouleToBtu(joule);
            default -> joule;
        };
    }
    ...
    /**
     * Converts provided joule value to kilojoules.
     *
     * @param joule joule value.
     * @return same energy converted to kilojoules.
     */
    ...
    /**
     * Converts provided joule value to calories.
     *
     * @param joule joule value.
     * @return same energy converted to calories.
     */
    ...
    /**
     * Converts provided joule value to kilocalories.
     *
     * @param joule joule value.
     * @return same energy converted to kilocalories.
     */
    ...
    /**
     * Converts provided joule value to kilowatt hours.
     *
     * @param joule joule value.
     * @return same energy converted to kilowatt hours.
     */
